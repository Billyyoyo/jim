...
func (c *socketServiceClient) SendMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *socketServiceClient) SendNotification(ctx context.Context, in *Notification, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *socketServiceClient) SendAction(ctx context.Context, in *Action, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (*UnimplementedSocketServiceServer) SendMessage(ctx context.Context, req *Message) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendMessage not implemented")
}
func (*UnimplementedSocketServiceServer) SendNotification(ctx context.Context, req *Notification) (*Empty, error) {
